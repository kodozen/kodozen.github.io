...
(function () {
  ...
  var BASLIK = {
    tr: { ana: "Kemer · Lokal İzmir", menu: "Menü · Kemer" },
    en: { ana: "Kemer · Lokal İzmir", menu: "Menu · Kemer" }
  };
  ...
  function dilUygula(d) {
    ...
    try { localStorage.setItem("kemer-dil", d); } catch (e) { /* gizli sekme */ }
  }
  ...
  var kayitli;
  try { kayitli = localStorage.getItem("kemer-dil"); } catch (e) { kayitli = null; }
